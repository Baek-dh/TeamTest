...
public class BoardController {
	...
	public String boardView(@PathVariable int type, @PathVariable int boardNo,
		...
		if(board != null) { // 게시글 조회 성공 시
			...
			rdAttr.addFlashAttribute("staus","error");
	...
	public ModelAndView updateAction(@PathVariable int type, @PathVariable int boardNo,
									 ModelAndView mv, Board upBoard, int cp, boolean[] deleteImages,
