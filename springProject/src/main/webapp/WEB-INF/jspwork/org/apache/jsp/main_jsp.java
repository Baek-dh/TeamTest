 ...
 * Generated at: 2020-08-26 02:49:55 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Spring Projcet</title>\r\n");
      ...
      out.write("\t\t\t\t<h3>자유게시판 조회수 Top5</h3>\r\n");
      out.write("\t\t\t\t<h5>(최근 5일 작성글)</h5>\r\n");
      ...
      out.write("\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tbody id=\"freeBoard-topViews\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$(function(){\r\n");
      out.write("\t\t\ttopViews(1); // 함수 호출\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 일정 시간(1분)마다 리스트 갱신\r\n");
      out.write("\t\t\tsetInterval(function(){topViews(1)}, 60000);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\r\n");
      out.write("\t\tfunction topViews(boardType){\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\turl : \"board/topViews/\" + boardType,\r\n");
      out.write("\t\t\t\tdataType : \"json\",\r\n");
      out.write("\t\t\t\tsuccess : function(list){\r\n");
      out.write("\t\t\t\t\tconsole.log(list);\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$(\"#freeBoard-topViews\").html(\"\"); // 리스트 갱신을 위해 이전 내용 삭제\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$.each(list, function(index, item){\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tvar $tr = $(\"<tr>\"); // 행\r\n");
      out.write("\t\t\t\t\t\tvar $td1 = $(\"<td>\").text(item.boardNo);\r\n");
      out.write("\t\t\t\t\t\tvar $td2 = $(\"<td>\").text(item.boardTitle);\r\n");
      out.write("\t\t\t\t\t\tvar $td3 = $(\"<td>\").text(item.boardWriter);\r\n");
      out.write("\t\t\t\t\t\tvar $td4 = $(\"<td>\").text(item.readCount);\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$tr.append($td1, $td2, $td3, $td4);\r\n");
      out.write("\t\t\t\t\t\t$(\"#freeBoard-topViews\").append($tr);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
